...
shell.exec('yarn run cross-env NODE_ENV=es5 babel lib-temp --out-dir es5 --source-maps --quiet')
// use babel to convert ESNext into ???; output to `lib/*.js`
shell.exec('yarn run cross-env NODE_ENV=lib babel lib-temp --out-dir lib --source-maps --quiet')
// remove lib-temp
